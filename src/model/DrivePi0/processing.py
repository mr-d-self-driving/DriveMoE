...
def normalize(
    ...
    assert (
        image.shape[2] == 3
    ), f"Expected 3 channels at axis 1, got {image.shape[2]} channels."
...
def process_images(
    images: torch.LongTensor,# [btz, num_images, rgb_channels, h, w]
...
class VLAProcessor:
    ...
    def __init__(
        ...
        self.image_seq_length = num_image_tokens # 256
        self.max_seq_len = max_seq_len # 296
    ...
    def __call__(
        ...
        # images: [btz, num_images, rgb_channels, h, w]
        # test: List [btz]
        assert (
        ...
        ) # ->[btz, num_images, rgb_channels, h, w]
